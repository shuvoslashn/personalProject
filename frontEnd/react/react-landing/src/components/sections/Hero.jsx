...
const Hero = () => {
    return (
        <section
            id='home'
            className='h-[calc(100vh-128px)] pt-[180px] bg-gray-50 dark:bg-gray-900 w-full'
        >
            <div className='container w-full h-full flex justify-center items-center'>
                <div className='relative text-center max-w-[940px]'>
                    ...
                    {/* Elements */}
                    <h3 className='text-xl md:text-3xl font-bold text-purple-600 pb-3'>
                        Welcome to BatterStack
                    </h3>
                    <h1 className='text-4xl md:text-6xl lg:text-8xl font-extrabold'>
                        <span className='font-outline-1 dark:font-outline-white-1 text-transparent'>
                            World of{" "}
                        </span>{" "}
                        <span>Machine</span>
                    </h1>
                    ...
                    >
                        ...
                        elit. Delectus aliquam qui excepturi officia veniam
                        nostrum nobis voluptatem adipisci.
                    </p>
